...
public class TestResultServiceTests
{
    ...
    public TestResultServiceTests()
    {
        ...
        _unitOfWorkMock.Setup(u => u.TestResults).Returns(_testResultRepositoryMock.Object);

        _service = new TestResultService(_unitOfWorkMock.Object);
    }
    ...
    public async Task GetByRunIdAsync_WithExistingRun_ReturnsResults()
    {
        ...
        _testResultRepositoryMock.Setup(r => r.GetByRunIdAsync(runId))
        ...
        _testResultRepositoryMock.Verify(r => r.GetByRunIdAsync(runId), Times.Once);
    }
