...
public class TestSuiteServiceTests
{
    ...
    public TestSuiteServiceTests()
    {
        ...
        _service = new TestSuiteService(_unitOfWorkMock.Object);
    }
    ...
    public async Task GetByProjectIdAsync_WithExistingProject_ReturnsSuites()
    {
        ...
        _testSuiteRepositoryMock.Setup(r => r.GetByProjectIdAsync(projectId))
            .ReturnsAsync(suites);
        ...
        _testSuiteRepositoryMock.Verify(r => r.GetByProjectIdAsync(projectId), Times.Once);
    }
