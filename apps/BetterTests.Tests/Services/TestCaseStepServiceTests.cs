...
public class TestCaseStepServiceTests
{
    ...
    public async Task GetByCaseIdAsync_WithExistingCase_ReturnsSteps()
    {
        ...
        _testCaseStepRepositoryMock.Setup(r => r.GetPagedByCaseIdAsync(caseId, It.IsAny<int>(), It.IsAny<int>()))
            .ReturnsAsync((steps, 1));
        ...
        _testCaseStepRepositoryMock.Verify(r => r.GetPagedByCaseIdAsync(caseId, It.IsAny<int>(), It.IsAny<int>()), Times.Once);
    }
    ...
    public async Task GetByCaseIdAsync_WithNoSteps_ReturnsEmptyList()
    {
        ...
        _testCaseRepositoryMock.Setup(r => r.GetByIdAsync(caseId)).ReturnsAsync(testCase);
        _testCaseStepRepositoryMock.Setup(r => r.GetPagedByCaseIdAsync(caseId, It.IsAny<int>(), It.IsAny<int>()))
            .ReturnsAsync((new List<TestCaseStep>(), 0));
    ...
    public async Task CreateAsync_WithValidRequest_CreatesSuccessfully()
    {
        ...
        _testCaseStepRepositoryMock.Setup(r => r.SaveChangesAsync()).ReturnsAsync(1);
        ...
        _testCaseStepRepositoryMock.Verify(r => r.SaveChangesAsync(), Times.Once);
    }
