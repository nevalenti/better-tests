...
public class TestCaseServiceTests
{
    ...
    public TestCaseServiceTests()
    {
        ...
        _service = new TestCaseService(_testSuiteRepositoryMock.Object, _testCaseRepositoryMock.Object, NullLogger<TestCaseService>.Instance);
    }
    ...
    public async Task GetBySuiteIdAsync_WithExistingSuite_ReturnsCases()
    {
        ...
        _testCaseRepositoryMock.Setup(r => r.GetPagedBySuiteIdAsync(suiteId, It.IsAny<int>(), It.IsAny<int>(), null, null)).ReturnsAsync((cases, 1));
        ...
        _testCaseRepositoryMock.Verify(r => r.GetPagedBySuiteIdAsync(suiteId, It.IsAny<int>(), It.IsAny<int>(), null, null), Times.Once);
    }
    ...
    public async Task GetBySuiteIdAsync_WithNoCases_ReturnsEmptyList()
    {
        ...
        _testSuiteRepositoryMock.Setup(r => r.GetByIdAsync(suiteId)).ReturnsAsync(suite);
        _testCaseRepositoryMock.Setup(r => r.GetPagedBySuiteIdAsync(suiteId, It.IsAny<int>(), It.IsAny<int>(), null, null)).ReturnsAsync((new List<TestCase>(), 0));
    ...
    public async Task GetBySuiteIdAsync_WithPriorityFilter_ReturnsFilteredCases()
    {
        ...
        var suiteId = Guid.NewGuid();
        var suite = new TestSuite { Id = suiteId, Name = "Test Suite" };
        var highPriorityCases = new List<TestCase>
        {
            new() { Id = Guid.NewGuid(), SuiteId = suiteId, Name = "High Priority", Priority = TestCasePriority.High, Status = TestCaseStatus.Active }
        };

        _testSuiteRepositoryMock.Setup(r => r.GetByIdAsync(suiteId)).ReturnsAsync(suite);
        _testCaseRepositoryMock.Setup(r => r.GetPagedBySuiteIdAsync(suiteId, It.IsAny<int>(), It.IsAny<int>(), TestCasePriority.High, null)).ReturnsAsync((highPriorityCases, 1));
    ...
    public async Task CreateAsync_WithValidRequest_CreatesSuccessfully()
    {
        ...
        _testCaseRepositoryMock.Setup(r => r.SaveChangesAsync()).ReturnsAsync(1);
        ...
        _testCaseRepositoryMock.Verify(r => r.SaveChangesAsync(), Times.Once);
    }
