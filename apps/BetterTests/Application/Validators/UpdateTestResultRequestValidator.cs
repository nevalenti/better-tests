...
public class UpdateTestResultRequestValidator : AbstractValidator<UpdateTestResultRequest>
{
    public UpdateTestResultRequestValidator()
    {
        RuleFor(x => x.Result)
        ...
        RuleFor(x => x.DefectLink)
            .MaximumLength(255).WithMessage("Defect link must not exceed 255 characters")
            .MustBeHttpUrl();
    }
}
